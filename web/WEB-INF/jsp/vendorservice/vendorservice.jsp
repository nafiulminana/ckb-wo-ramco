...
<html>
    ...
    <body>
        ...
        <display:table name="vendorservice" id="vendorservicetable" partialList="true" size="requestScope.count" pagesize="${requestScope.pagesize}" requestURI="vendorservice" sort="external">
            <display:column property="vendor.vendorname" href="vendorservice?act=edit" paramId="tvendorservicePk" paramProperty="tvendorservicePk" title="Vendor" sortable="true" sortName="vendorname" headerClass="sortable" />
