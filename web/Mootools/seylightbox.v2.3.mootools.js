/**
 * Sey LightBox - for mootools 1.2.3
 * @name      seylightbox.v2.3.js
 * @author    Eduardo D. Sada - http://www.coders.me/web-html-js-css/javascript/sey-lightbox-2
 * @version   2.3.3
 * @date      30-Oct-2009
 * @copyright (c) 2009 Eduardo D. Sada (www.coders.me)
 * @license   MIT - http://es.wikipedia.org/wiki/Licencia_MIT
 * @example   http://www.coders.me/ejemplos/sey-lightbox-2/
*/
...
var SeyLightBox = new Class(
{
  Implements: [Options, Events],
    ...
    dir           : 'seyimages',
    emergefrom    : 'top',
    background    : 'bgSey.png',
    backgroundIE  : 'bgSey.gif',
    buttons       : 'buttons.png',
    displayed     : 0,
    showDuration  : 200,
